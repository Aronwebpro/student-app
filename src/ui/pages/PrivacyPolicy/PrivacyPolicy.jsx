...
//Style
import './privacy-policy-container.css';
            ...
            <div className="container  privacy-policy-container">
                <div className='card-container privacy-policy-body'>
                    ...
                    <div>
                        ...
                        <p>Magic Skating ("us", "we", or "our") operates the taira.lt website (the "Service").</p>
                        ...
                        <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of
                            ...
                            Privacy Policy have the same meanings as in our Terms and Conditions, accessible from taira.lt</p>
                        ...
                        <h2>Use of Data</h2>
                        <p>Magic Skating uses the collected data for various purposes:</p>
                        <ul>
                        ...
                        <p>If you are located outside Lithuania and choose to provide information to us, please note that we transfer the data,
                            including Personal Data, to Lithuania and process it there.</p>
                        <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that
                            transfer.</p>
                        <p>Magic Skating will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
                        ...
                        <p>Magic Skating may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                        <ul>
                            <li>To comply with a legal obligation</li>
                            <li>To protect and defend the rights or property of Magic Skating</li>
                        ...
                        <p>We do not knowingly collect personally identifiable information from anyone under the age of 18. If you are a parent or
                            guardian and you are aware that your Children has provided us with Personal Data, please contact us. If we become
                        ...
                        <ul>
                            <li>By email: skatingmagiclessons@gmail.com</li>
